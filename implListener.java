...
public interface implListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link implParser#declaration}.
	 * @param ctx the parse tree
	 */
	void enterDeclaration(implParser.DeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link implParser#declaration}.
	 * @param ctx the parse tree
	 */
	void exitDeclaration(implParser.DeclarationContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterAccess(implParser.AccessContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Access}
	 * labeled alternative in {@link implParser#lhs}.
	 * @param ctx the parse tree
	 */
	void exitAccess(implParser.AccessContext ctx);
	/**
	 * Enter a parse tree produced by {@link implParser#assign}.
	 * @param ctx the parse tree
	 */
	void enterAssign(implParser.AssignContext ctx);
	/**
	 * Exit a parse tree produced by {@link implParser#assign}.
	 * @param ctx the parse tree
	 */
	void exitAssign(implParser.AssignContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code Specification}
	 * labeled alternative in {@link implParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterSpecification(implParser.SpecificationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code Specification}
	 * labeled alternative in {@link implParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitSpecification(implParser.SpecificationContext ctx);
	/**
