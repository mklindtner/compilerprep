...
public interface implVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link implParser#declaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaration(implParser.DeclarationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAccess(implParser.AccessContext ctx);
	/**
	 * Visit a parse tree produced by {@link implParser#assign}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssign(implParser.AssignContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code Specification}
	 * labeled alternative in {@link implParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpecification(implParser.SpecificationContext ctx);
	/**
